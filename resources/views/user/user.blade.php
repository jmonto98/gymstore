        ...
        <div class="card-header">Create User</div>
          <div class="card-body">
            <form method="POST" action="#">
              ...
              <select class="form-control" name="Rol" id="species" required placeholder="Enter Rol"> 
                <option value="">Select Role</option> 
                <option value="0">Administrator</option> 
                <option value="1">User</option> 
              </select><br>
             <!--  <input type="text" class="form-control mb-2" placeholder="State" name="state" require/> -->
             <select class="form-control" name="state" id="species" required placeholder="Enter state"> 

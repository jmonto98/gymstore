      ...
      <form method='POST' action='{{ route('admin.user.update', ['id' => $viewData['user']->getId()]) }}'>
        ...
        <div class='row mb-3'>
          <div class='col-md-4'>
            ...
            <input id='name' name='name' value='{{ old('Name', $viewData['user']->getName()) }}' type='text'
              class='form-control' required>
          </div>
          <div class='col-md-4'>
            <label for='lastName' class='form-label'>{{ __('messages.last_name') }}:</label>
            <input id='lastName' name='lastName' value='{{ old('LastName', $viewData['user']->getLastName()) }}'
          ...
          <div class='col-md-4'>
            ...
            <input type='text' id='username' name='username'
              value='{{ old('Username', $viewData['user']->getUsername()) }}' class='form-control' required>
          </div>
          <div class='col-md-4'>
            <label for='password' class='form-label'>{{ __('messages.password') }}:</label>
            <input type='password' minlength='8' id='password' name='password'
              value='{{ old('Password', $viewData['user']->getPassword()) }}' class='form-control' required>
          </div>
          <div class='mb-3'>
          ...
          <div class='md-3'>
            ...
            <input type='number' id='balance' name='balance'
              value='{{ old('Balance', $viewData['user']->getBalance()) }}' class='form-control' required>
          </div>
          <br>

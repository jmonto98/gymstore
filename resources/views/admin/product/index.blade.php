      ...
      <form method='POST' action='{{ route('admin.product.store') }}' enctype='multipart/form-data'>
        ...
        <div class='row mb-3'>
          ...
          <div class='col-md-4'>
            ...
            <input id='price' name='price' value='{{ old('price') }}' type='number' step='0.01' class='form-control'
              required>
          </div>
          <div class='col-md-4'>
      ...
      @endforeach
        ...
        <div class='mb-3'>
          ...
          <select id='state' name='state' class='form-select' required>
            ...
            <option value='inactive' {{ old('state') == 'inactive' ? 'selected' : '' }}>{{ __('messages.inactive') }}
            </option>
          </select>
        </div>
        <div class='mb-3'>

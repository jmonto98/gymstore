        ...
        <form method='POST' action='{{ route('admin.product.update', ['id' => $viewData['product']->getId()]) }}' enctype='multipart/form-data'>
            ...
            <div class='row mb-3'>
                <div class='col-md-6'>
                    ...
                    <input id='name' name='name' value='{{ old('name', $viewData['product']->getName()) }}' type='text' class='form-control' required>
                </div>
                <div class='col-md-6'>
                    <label for='price' class='form-label'>{{ __('messages.price') }}:</label>
                    <input id='price' name='price' value='{{ old('price', $viewData['product']->getPrice()) }}' type='number' step='0.01' class='form-control' required>
                </div>
            </div>
            ...
            <div class='row mb-3'>
                <div class='col-md-6'>
                    ...
                    <input id='stock' name='stock' value='{{ old('stock', $viewData['product']->getStock()) }}' type='number' class='form-control' required>
                </div>
                <div class='col-md-6'>
            ...
            <div class='row mb-3'>
                ...
                <div class='col-md-6'>
                    ...
                    <div class='mb-3'><br>
                        <img src='{{ asset('storage/' . $viewData['product']->getImage()) }}' alt='Current Image' class='img-fluid' style='max-height: 150px;'>
                    </div>
                    @endif
                </div>
            </div>

...
<body>
    ...
    <div class='container'>
      ...
      <div class='collapse navbar-collapse' id='navbarIcons'>
        <ul class='navbar-nav ms-auto'>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.index') }}'><i class='fas fa-home'></i>
              {!! __('messages.home') !!}</a>
          </li>
          <li class='nav-item'>
          ...
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.about') }}'><i class='fas fa-info-circle'></i>
              {!! __('messages.about') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.contact') }}'><i class='fas fa-envelope'></i>
  ...
  <nav class='navbar navbar-expand-lg navbar-dark bg-primary py-4'>
    <div class='container'>
      <a class='navbar-brand' href='/'>{!! __('messages.brand') !!}</a>
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarIconsBelow'
        aria-controls='navbarIconsBelow' aria-expanded='false' aria-label='Toggle navigation'>
        <span class='navbar-toggler-icon'></span>
      </button>
  ...
  <nav class='navbar navbar-expand-lg navbar-light bg-light py-4'>
    <div class='container'>
      ...
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarCircleIcons'
        aria-controls='navbarCircleIcons' aria-expanded='false' aria-label='Toggle navigation'>
        <span class='navbar-toggler-icon'></span>
      </button>
      <div class='collapse navbar-collapse' id='navbarCircleIcons'>
        <ul class='navbar-nav ms-auto'>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.index') }}'><span
                class='bg-primary text-white rounded-circle p-2'><i class='fas fa-home'></i></span>
              {!! __('messages.home') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('cart.index') }}'><span
                class='bg-success text-white rounded-circle p-2'><i class='fas fa-shopping-cart'></i></span>
              {!! __('messages.cart') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='#'><span class='bg-info text-white rounded-circle p-2'><i
                  class='fas fa-user'></i></span> Perfil</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.about') }}'><span
                class='bg-warning text-white rounded-circle p-2'><i class='fas fa-info-circle'></i></span>
              {!! __('messages.about') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.contact') }}'><span
                class='bg-danger text-white rounded-circle p-2'><i class='fas fa-envelope'></i></span>
              {!! __('messages.contact_us') !!}</a>
          </li>
        </ul>
      </div>
  ...
  <nav class='navbar navbar-expand-lg navbar-light bg-light py-4'>
    <div class='container'>
      <a class='navbar-brand' href='/'><i class='fas fa-dumbbell me-2'></i>{!! __('messages.brand') !!}</a>
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarDeportivo'
        aria-controls='navbarDeportivo' aria-expanded='false' aria-label='Toggle navigation'>
        <span class='navbar-toggler-icon'></span>
      </button>
        ...
        <ul class='navbar-nav ms-auto'>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.index') }}'><i
                class='fas fa-running me-2'></i>{!! __('messages.home') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('cart.index') }}'><i
                class='fas fa-shopping-bag me-2'></i>{!! __('messages.cart') !!}</a>
          </li>
          <li class='nav-item'>
          ...
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.contact') }}'><i
                class='fas fa-headset me-2'></i>{!! __('messages.contact_us') !!}</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <nav class='navbar navbar-expand-lg navbar-light bg-white py-4 border-bottom'>
    <div class='container'>
      ...
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarMinimalista'
        aria-controls='navbarMinimalista' aria-expanded='false' aria-label='Toggle navigation'>
        <span class='navbar-toggler-icon'></span>
      </button>
  ...
  <nav class='navbar navbar-expand-lg navbar-dark bg-gradient py-4'
    style='background: linear-gradient(45deg, #ff4e50, #f9d423);'>
    <div class='container'>
      <a class='navbar-brand' href='/'><i class='fas fa-bolt me-2'></i>{!! __('messages.brand') !!}</a>
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarEnergetico'
        aria-controls='navbarEnergetico' aria-expanded='false' aria-label='Toggle navigation'>
        <span class='navbar-toggler-icon'></span>
      </button>
      <div class='collapse navbar-collapse' id='navbarEnergetico'>
        <ul class='navbar-nav ms-auto'>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.index') }}'><i
                class='fas fa-home me-2'></i>{!! __('messages.home') !!}</a>
          </li>
          <li class='nav-item'>
          ...
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('cart.index') }}'><i
                class='fas fa-shopping-cart me-2'></i>{!! __('messages.cart') !!}</a>
          </li>
          <li class='nav-item'>
            <a class='nav-link' href='{{ route('home.contact') }}'><i
                class='fas fa-envelope me-2'></i>{!! __('messages.contact_us') !!}</a>
          </li>
        </ul>
      </div>
    </div>

...
<body>
            ...
            <nav class='col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse'>
                <div class='position-sticky pt-3'>
                    ...
                    <ul class='nav flex-column'>
                        ...
                        <li class='nav-item'>
                            <a class='nav-link text-white' href='{{ route('admin.category.index') }}'>{{ __('messages.categories') }}</a>
                        </li>
                        <li class='nav-item'>
    ...
    <footer class='bg-dark text-center text-white py-4'>
        <div class='container'>
            <small>
                {{ __('messages.copyright') }} - <a class='text-reset fw-bold text-decoration-none' target='_blank' href='https://twitter.com/danielgarax'>{{ __('messages.brand') }}</a>
            </small>
        </div>
    </footer>

...
Route::get('api/partner', 'App\Http\Controllers\Api\Partner\PartnerController@index')->name('partner.index');
...
Route::get('/language/change', "App\Http\Controllers\LanguageController@change")->name('language.change');
...
Route::middleware([AdminAuthMiddleware::class])->group(function () {
    ...
    Route::get('/admin/order/{id}/show', 'App\Http\Controllers\Admin\AdminOrderController@show')->name('admin.order.show');
});
